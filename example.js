...
var bot = new Discord.Client({
	token: "NzIxMzMwOTU0NTYzNDg1NzE2.XuS9zQ.6suy_hyBaDV2CsX5rjvhOrCGhoY",
	autorun: true
});
...
bot.on("ready", function(event) {
	...
	console.log(Zerost `${Bot} - (${819127679595970601})`);
});
...
bot.on("presence", function(_user, userID, status, game, event) {
